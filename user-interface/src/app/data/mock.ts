...
/** 3D aerial view shots — x,y in meters (table 1.525m × 2.74m) */
...
export const shots3D: Shot3D[] = [
  { id: "1", player: "you", x: 0.3, y: 0.5, won: true, spin: "topspin", shotType: "forehand" },
  { id: "2", player: "opponent", x: 1.2, y: 0.8, won: false, spin: "backspin", shotType: "backhand" },
  { id: "3", player: "you", x: 1.0, y: 0.3, won: true, spin: "topspin", shotType: "serve" },
  { id: "4", player: "opponent", x: 0.2, y: 1.5, won: true, spin: "sidespin", shotType: "forehand" },
  { id: "5", player: "you", x: 1.3, y: 1.1, won: false, spin: "flat", shotType: "smash" },
  { id: "6", player: "opponent", x: 0.75, y: 0.9, won: false, spin: "backspin", shotType: "push" },
  { id: "7", player: "you", x: 0.5, y: 2.0, won: true, spin: "topspin", shotType: "loop" },
  { id: "8", player: "opponent", x: 1.1, y: 1.8, won: false, spin: "topspin", shotType: "drive" },
  { id: "9", player: "you", x: 0.15, y: 0.2, won: true, spin: "backspin", shotType: "serve" },
  { id: "10", player: "opponent", x: 1.35, y: 2.4, won: true, spin: "flat", shotType: "block" },
];
